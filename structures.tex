    ...
    \resizebox{0.32\textwidth}{!}{
      \begin{tikzpicture}
        ...
        \graph [simple necklace layout, grow'=down, node sep=3em,nodes={draw,ellipse},
          ...
          marked/.style={thick,fill=gray}]
               {
                 Adrian[visited] -- Jackie[visited] -- Brittany[visited] --
                 Faith[marked] -- Kim[marked] -- Elaine[marked] --
                 Izzy[marked] -- Greg[visited] -- Chuck[visited] --
                 Adrian;
                 Brittany -- Kim;
                 Elaine -- {Faith, Jackie};
      ...
      \begin{tikzpicture}
        ...
        \graph [simple necklace layout, grow'=down, node sep=3em,nodes={draw,ellipse},
          ...
          marked/.style={thick,fill=gray}]
               {
                 Adrian[visited] -- Jackie[visited] -- Brittany[visited] --
                 Faith[marked] -- Kim[visited] -- Elaine[marked] --
                 Izzy[marked] -- Greg[visited] -- Chuck[visited] --
                 Adrian;
                 Brittany -- Kim;
                 Elaine -- {Faith, Jackie};
      ...
      \begin{tikzpicture}
        ...
        \graph [simple necklace layout, grow'=down, node sep=3em,nodes={draw,ellipse},
          ...
          marked/.style={thick,fill=gray}]
               {
                 Adrian[visited] -- Jackie[visited] -- Brittany[visited] --
                 Faith[visited] -- Kim[visited] -- Elaine[marked] --
                 Izzy[marked] -- Greg[visited] -- Chuck[visited] --
                 Adrian;
                 Brittany -- Kim;
                 Elaine -- {Faith, Jackie};
...
\begin{figure}[ht]
  ...
  \begin{custommargins}{-2.4cm}{-2.8cm}
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
            every edge/.style={draw,nodes={draw=none},dotted},
            visited/.style={fill=black,text=white},
            current/.style={thick,fill=gray},
            connected/.style={solid,ultra thick}]
          \node[draw=none,align=left,font=\Large,thick] at (-4,3) {1};
          \node (V)[visited] at (0,0) {Vichy};
          \node (L)[current] at (2,-1.3) {Lyon};
          \node (B) at (4.5,-2) {Briançon};
          \node (N) at (5,-3.5) {Nice};
          \node (M) at (2,-3.6) {Marseille};
          \node (T) at (-1.5,-3.5) {Toulouse};
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
          ...
          \node[draw=none,align=left,font=\Large,thick] at (-4,3) {2};
          \node (V)[visited] at (0,0) {Vichy};
          \node (L)[visited] at (2,-1.3) {Lyon};
          \node (B) at (4.5,-2) {Briançon};
          \node (N) at (5,-3.5) {Nice};
          \node (M)[current] at (2,-3.6) {Marseille};
          \node (T) at (-1.5,-3.5) {Toulouse};
          \node (Bdx) at (-3,-1.7) {Bordeaux};
          \node (Nts) at (-4,1) {Nantes};
          \node (P) at (-2,2) {Paris};
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
          ...
          \node (L)[visited] at (2,-1.3) {Lyon};
          \node (B) at (4.5,-2) {Briançon};
          \node (N)[current] at (5,-3.5) {Nice};
          \node (M)[visited] at (2,-3.6) {Marseille};
          \node (T) at (-1.5,-3.5) {Toulouse};
          \node (Bdx) at (-3,-1.7) {Bordeaux};
          \node (Nts) at (-4,1) {Nantes};
          \node (P) at (-2,2) {Paris};
          ...
          \graph [multi] {
            (V) --[connected,"250"] (L) --["200"] (B) --["250"] (N)
            --[connected,"150"'] (M) --[connected,"150"'] (L) --["600"] (T)
            --["300"] (M);
            (T) --["300"'] (V) --["450"] (Bdx) --["150"'] (Nts)
            --["300"] (P) --["350"] (Lle) --["500"] (S) --["400"] (B);
            (T) --["200"] (Bdx);
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
          ...
          \node (V)[visited] at (0,0) {Vichy};
          \node (L)[visited] at (2,-1.3) {Lyon};
          \node (B)[current] at (4.5,-2) {Briançon};
          \node (N)[visited] at (5,-3.5) {Nice};
          \node (M)[visited] at (2,-3.6) {Marseille};
          \node (T) at (-1.5,-3.5) {Toulouse};
          \node (Bdx) at (-3,-1.7) {Bordeaux};
          \node (Nts) at (-4,1) {Nantes};
          ...
          \node (S) at (5,2.5) {Strasbourg};
          \graph [multi] {
            (V) --[connected,"250"] (L) --[connected,"200"] (B) --["250"] (N)
            --[connected,"150"'] (M) --[connected,"150"'] (L) --["600"] (T)
            --["300"] (M);
            (T) --["300"'] (V) --["450"] (Bdx) --["150"'] (Nts)
            --["300"] (P) --["350"] (Lle) --["500"] (S) --["400"] (B);
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
          ...
          \node (V)[visited] at (0,0) {Vichy};
          \node (L)[visited] at (2,-1.3) {Lyon};
          \node (B)[visited] at (4.5,-2) {Briançon};
          \node (N)[visited] at (5,-3.5) {Nice};
          \node (M)[visited] at (2,-3.6) {Marseille};
          \node (T)[current] at (-1.5,-3.5) {Toulouse};
          \node (Bdx) at (-3,-1.7) {Bordeaux};
          \node (Nts) at (-4,1) {Nantes};
          \node (P) at (-2,2) {Paris};
          \node (Lle) at (0.3,3) {Lille};
          ...
          \graph [multi] {
            ...
            --[connected,"150"'] (M) --[connected,"150"'] (L) --["600"] (T)
            --["300"] (M);
            (T) --[connected,"300"'] (V) --["450"] (Bdx) --["150"'] (Nts)
            --["300"] (P) --["350"] (Lle) --["500"] (S) --["400"] (B);
            (T) --["200"] (Bdx);
            (Lle) --["400"] (V) --["350"'] (P);
            (L) --["650"] (S);
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
          ...
          \node (N)[visited] at (5,-3.5) {Nice};
          \node (M)[visited] at (2,-3.6) {Marseille};
          \node (T)[visited] at (-1.5,-3.5) {Toulouse};
          \node (Bdx)[current] at (-3,-1.7) {Bordeaux};
          \node (Nts) at (-4,1) {Nantes};
          \node (P) at (-2,2) {Paris};
          \node (Lle) at (0.3,3) {Lille};
          \node (S) at (5,2.5) {Strasbourg};
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
          ...
          \node (M)[visited] at (2,-3.6) {Marseille};
          \node (T)[visited] at (-1.5,-3.5) {Toulouse};
          \node (Bdx)[visited] at (-3,-1.7) {Bordeaux};
          \node (Nts)[current] at (-4,1) {Nantes};
          \node (P) at (-2,2) {Paris};
          \node (Lle) at (0.3,3) {Lille};
          \node (S) at (5,2.5) {Strasbourg};
          \graph [multi] {
            ...
            --[connected,"150"'] (M) --[connected,"150"'] (L) --["600"] (T)
            --["300"] (M);
            (T) --[connected,"300"'] (V) --["450"] (Bdx) --[connected,"150"'] (Nts)
            --["300"] (P) --["350"] (Lle) --["500"] (S) --["400"] (B);
            (T) --[connected,"200"] (Bdx);
            (Lle) --["400"] (V) --["350"'] (P);
            (L) --["650"] (S);
    ...
    \framebox{
      \resizebox{0.5\textwidth}{!}{
        \begin{tikzpicture}[every node/.style={draw,ellipse,inner sep=1pt},
            ...
            current/.style={thick,fill=gray},
            connected/.style={solid,ultra thick}]
          \node[draw=none,align=left,font=\Large,thick] at (-4,3) {$\cdots$};
          \node (V)[visited] at (0,0) {Vichy};
          \node (L)[visited] at (2,-1.3) {Lyon};
          \node (B)[visited] at (4.5,-2) {Briançon};
          \node (N)[visited] at (5,-3.5) {Nice};
          ...
          \node (T)[visited] at (-1.5,-3.5) {Toulouse};
          \node (Bdx)[visited] at (-3,-1.7) {Bordeaux};
          \node (Nts)[visited] at (-4,1) {Nantes};
          \node (P)[visited] at (-2,2) {Paris};
          \node (Lle)[visited] at (0.3,3) {Lille};
          \node (S)[visited] at (5,2.5) {Strasbourg};
          \graph [multi] {
            (V) --[connected,"250"] (L) --[connected,"200"] (B) --["250"] (N)
            --[connected,"150"'] (M) --[connected,"150"'] (L) --["600"] (T)
            --["300"] (M);
            (T) --[connected,"300"'] (V) --["450"] (Bdx) --[connected,"150"'] (Nts)
            --[connected,"300"] (P) --[connected,"350"] (Lle) --["500"] (S) --[connected,"400"] (B);
            (T) --[connected,"200"] (Bdx);
            (Lle) --["400"] (V) --["350"'] (P);
            (L) --["650"] (S);
          };
...
\centering
\resizebox{0.7\textwidth}{!}{
  \tikz [grow=down,binary tree layout,nodes={circle,draw,minimum size=3em}]
  \node {G}
  child { node {K}
    child { node {D}
      child { node {}}
...
\resizebox{0.65\textwidth}{!}{
  \tikz [grow=down,binary tree layout,nodes={circle,draw,minimum size=5em,sibling distance=7em}]
  \node {Ben} {
    child[missing]
    child { node {Jennifer} {
        child[missing]
