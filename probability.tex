...
\resizebox{0.7\textwidth}{!}{
  \begin{tikzpicture}[elem/.style={fill=black,circle,inner sep=1pt}]
    ...
    \node (c) [right=100pt of a,elem,label={[name=Lc,above]:Fantasia (.2)}] {};
    \node (d) [right=210pt of b,elem,label={[name=Ld,above]:Carrie (.1)}] {};
    \node[draw,dotted,ellipse,fit=(a) (La) (c) (Lc),label={[right,inner sep=55pt,font=\tiny]:Underage}] {};
    \node[draw,dashed,regular polygon,regular polygon sides=4,fit=(a) (c) (d),label={[above,font=\tiny]Female}] {};
    \node[draw,solid,tape,fit=(a) (La) (b) (Lb),label={[above,font=\tiny]:Rockstar}] {};
  \end{tikzpicture}
}
...
\index{movie theatre}
\index{Spiderman@\textit{Spiderman: No Way Home}}
\index{Here Before@\textit{Here Before}}
\index{Sonic the Hedgehog@\textit{Sonic the Hedgehog}}
